...
recorder's line or earphone output to that input, set **Tape input** to **ADC** on the OSD,
start the tape and load as usual, with `CLOAD` in N-BASIC or `LOAD"CAS1:"` in N88-BASIC.
Both tape speeds (600 and 1200 baud) work; the core follows the one the machine selects.
